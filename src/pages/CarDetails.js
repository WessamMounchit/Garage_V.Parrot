      ...
      <section>
        <Container>
          <Row>
              ...
              <div className='icons__container'>
                <div className='icons__group'>
                  <span className=" d-flex align-items-center gap-1 section__description">
                    <i class="ri-roadster-line icons__details" />
                    {car.data?.year}
                  </span>

                  <span className=" d-flex align-items-center gap-1 section__description">
                    <i class="ri-settings-2-line icons__details" />
                    {car.data?.automatic}
                  </span>
                ...
                <div className="icons__group">
                  ...
                  <span className=" d-flex align-items-center gap-1 section__description">
                    <i class="ri-building-2-line icons__details" />
                    {car.data?.brand}
                  </span>

                  <span className=" d-flex align-items-center gap-1 section__description">
                    <i class="ri-wheelchair-line icons__details" />
                    {car.data?.seat}
                  </span>
                </div>
              </div>
            ...
            <Col lg="12" className='contact__details' /* style={{marginTop: "8rem"}} */>
