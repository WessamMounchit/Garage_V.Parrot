        ...
        <tbody>
          {sortedOpeningHours.map((openingHour) => (
            <tr key={openingHour.day}>
              ...
              <td data-label="Matin ouverture">
                {openingHour.morning_open ? openingHour.morning_open : "Fermé"}
              </td>
              <td data-label="Matin fermeture">
                {openingHour.morning_close
                  ? openingHour.morning_close
                  : "Fermé"}
              </td>
              <td data-label="Après-midi ouverture">
                {openingHour.afternoon_open
                  ? openingHour.afternoon_open
                  : "Fermé"}
              </td>
              <td data-label="Après-midi fermeture">
                {openingHour.afternoon_close
                  ? openingHour.afternoon_close
                  : "Fermé"}
              </td>
